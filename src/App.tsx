...
function App() {
    ...
    let [tl, setTl] = useState<Array<TodolistDomainType>>([
        {id: tlID1, title: 'What to learn', filter: 'ALL', order: 0, addedDate: ''},
        {id: tlID2, title: 'What to buy', filter: 'ALL', order: 1, addedDate: ''}
    ])
    ...
    const addTl = (title: string) => {
        let newID = v1();
        setTl([{id: newID, title, filter: 'ALL', order: 0, addedDate: ''}, ...tl])
